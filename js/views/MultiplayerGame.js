...
// The engine is wired with a multiplayerConfig object from app.js.

export default function MultiplayerGame({ myName, oppName, targetScore, gameMode, isMyTurn }) {
    const modeClass = gameMode === 'pingpong' ? ' bg-pingpong' : '';

    return `
        <div id="game-screen" class="view-screen${modeClass}">

            <!-- Rotate-to-landscape warning (same as solo game) -->
            ...
            <div id="mp-game-hud">
                ...
                <div class="mp-hud-scores">
                    ...
                    <div class="mp-hud-center-col">
                        ...
                        <span class="mp-turn-indicator" id="mp-turn-indicator">
            ...
            <!-- Score area — hidden but needed by the engine for DOM refs -->
            ...
            <!-- Challenge badge — hidden; engine refs it but director is off in MP -->
            ...
            <!-- Toast container ("+1", "💔 Bonus Lost", etc.) -->
            ...
            <!-- Countdown overlay (shown for 3 s at game start) -->
            ...
            <!-- Wait overlay (shown while it's not your turn) -->
